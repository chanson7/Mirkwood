...
public struct InputPayload
{
    ...
    public int TriggeredAnimationHash;
...
public class PlayerPredictedTransform : NetworkBehaviour
{
    float timer;
    int currentTick;
    ...
    void Start()
    {
        ...
        playerRotation = this.GetComponent<PlayerRotation>();
    }
    ...
    StatePayload ProcessInput(InputPayload input)
    {
        ...
        //run the state through each processing component
