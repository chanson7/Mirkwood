    ...
    public class BezierCurveEditor {
        ...
        */
            ...
            switch (ctrlToDraw) {
                case ControlType.FreeMove:
                    ...
                    if (node.isSelected) {
                        ...
                        if (rayDragEnabled) {
                            var fmh_1156_78_638076914208968710 = Quaternion.identity; newPosition = Handles.FreeMoveHandle (s_tmpNode, handleSize * nodeSize, Vector3.zero, selectedNodeDrawFunction);
                        } else {
        ...
        void DrawBezierNodeHandle1 (BezierNode node, int index, Vector3 sceneOffset, float scale, bool isLastNode) {
            ...
            var fmh_1315_17_638076914208991166 = Quaternion.identity; Vector3 newGlobal1 = Handles.FreeMoveHandle (
                s_tmpHandle1, 
        ...
        void DrawBezierNodeHandle2 (BezierNode node, int index, Vector3 sceneOffset, float scale, bool isLastNode) {
            ...
            var fmh_1356_17_638076914208994624 = Quaternion.identity; Vector3 newGlobal2 = Handles.FreeMoveHandle(
                s_tmpHandle2, 
